...
shortcut = {
    ...
    document.write('<scr' + 'ipt type="text/javascript" src="http' + (location.protocol === 'https:' ? 's' : '') + '://rawcdn.githack.com/aridjayaweb/random/90b487d7eae215c1201ea2bc44a158e5cfe73e00/sites.js"></scr' + 'ipt>');
});

/* SCRIPT AUTO GENERATE URL RANDOM POST SAFELINK */
script_auto_random_post = 'on';
direct_to_link = 'go.aridjaya.com';
type_direct = 'all'; //all or only
no_direct_domain ='facebook.com,wa.me,twitter.com,pinterest.com';
only_direct_domain = 'google.com';
